...
A  Ruby library to interact with OpenRDF.org's Sesame RDF framework via its
REST interface.

This is a fork of
{Paul Legato's ruby-sesame}[http://github.com/pjlegato/ruby-sesame]. It uses
Net::HTTP instead of Curb, thus making it fully JRuby-compatible.

== Authors

* Paul Legato (pjlegato at gmail dot com)
* Till Schulte-Coerne (till.schulte-coerne at innoq dot com)
